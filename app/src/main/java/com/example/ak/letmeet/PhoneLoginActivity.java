    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(PhoneLoginActivity.this, "Please write the Code first..", Toast.LENGTH_LONG).show();
                }
                else
                {
                    loadingBar.setTitle("Code Verification in Process");
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
        {
                                   ...
                                   PhoneAuthProvider.ForceResendingToken token)
            {
                ...
                Toast.makeText(PhoneLoginActivity.this, "Code has been to your Phone, Please Check..", Toast.LENGTH_LONG).show();
