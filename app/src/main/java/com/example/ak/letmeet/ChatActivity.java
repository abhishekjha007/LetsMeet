...
public class ChatActivity extends AppCompatActivity
{
                ...
                builder.setItems(options, new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        /*if(i == 1)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent, "Select PDF file to Send."), 438);
                        }
                        if(i == 2)
                        {
                            checker = "docx";
                            ...
                            startActivityForResult(intent.createChooser(intent, "Select MS Word file to Send."), 438);
                        }*/
                    }
                });
                builder.show();
    ...
    private void InitializeControllers()
    {
        ...
        saveCurrentDate = currentDate.format(calenderDate.getTime());
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener()
                            {
                                ...
                                public void onComplete(@NonNull Task task)
                                {
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(ChatActivity.this, "Error Occurred..", Toast.LENGTH_LONG).show();
                                    }
